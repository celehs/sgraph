...
#'                             displayed. 
#' @param label_size Sigma.js corresponding parameter，Controls the base size of labels
#' @param label_size_ratio Sigma.js corresponding parameter.Modifies label_size based on label_grid_cell_size value.. 
#'
...
sigma_from_igraph <- function(igraph, layout = NULL, label_color = '#fff',
                              ...
                              elementId = NULL, label_grid_cell_size = 200,label_size = 7,label_size_ratio=0.02) {
  ...
  label_size <- label_size+label_grid_cell_size * label_size_ratio
